...
export async function saveStorageMaintenanceConfig({ executor, config, actor = null } = {}) {
  ...
  try {
    ...
    `UPDATE public.storage_maintenance_config SET
       ...
       webhook_url = NULLIF($9, ''), cleanup_enabled = FALSE,
       cleanup_interval_seconds = $10, automatic_categories = '[]'::jsonb,
       orphan_grace_seconds = $11, updated_by_user_id = $12::bigint,
...
export const storageMaintenanceRepositoryInternals = Object.freeze({ configFromRow, queryFrom });
