...
import {
  ...
  getDatabaseBackupRequestStatus,
...
export async function createDatabaseBackup({ actor } = {}) {
  return requestDatabaseBackup({ actor });
}

export async function readDatabaseBackupRequest({ requestId, actor } = {}) {
  return getDatabaseBackupRequestStatus({ requestId, actor });
}
...
export async function updateManualImageRetention({ input, actor } = {}) {
  return setManualImageRetentionPolicy({
    actor,
