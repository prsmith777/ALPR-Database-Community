export const SETTINGS_HELP_COVERAGE = Object.freeze([
  ...
  },
  {
    ...
    requiredTerms: ["database host & port", "replacement-only", "verified backup"],
  },
  {
  ...
  },
  {
    ...
    requiredTerms: ["two credential directions", "/api/plate-reads", "x-api-key", "&alert_jpeg", "trigger_type", "motion_a>b"],
  },
  {
