...
export async function startMaintenanceRuntime({
  ...
  if ([schedule, getDatabase, loadSettings, ensureState, runDue, ensureReconciliationState, runReconciliation, getStorageBaseDir].some((value) => typeof value !== "function")) {
