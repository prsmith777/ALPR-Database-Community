...
class ManualPdfLayout {
  ...
  renderBlock(block) {
    ...
    // Keep a block heading with at least the first line of its content.
    this.ensureSpace(54);
  ...
  render() {
    ...
    this.manual.sections.forEach((section, index) => {
      if (section.pageBreakBefore && this.y < PAGE_HEIGHT - MARGIN) this.newPage();
      // Keep a section heading, summary, role line, and first block together.
