...
export async function getPlateReads({
  ...
  return withClient(async (client) => {
    ...
    const pagedGroupBy = sortsByTags
      ? "GROUP BY pr.id, p.occurrence_count, direction.direction_label, radar.speed_mph"
      : "";
    ...
    const dataQuery = `
      ...
      GROUP BY 
        ...
        radar.speed_mph,
        radar.direction,
        radar.event_timestamp,
        radar.match_delta_ms,
        ...
        direction.orientation_confidence,
        direction.direction_label,
        direction.sample_counts,
        pr.bi_trigger_direction_error_code,
        direction_profile.camera_key,
        vehicle_color.status,
        vehicle_color.attribute_value,
        vehicle_color.confidence,
        vehicle_color.reason,
        vehicle_type.status,
        vehicle_type.attribute_value,
        vehicle_type.confidence,
        cluster_assignment.cluster_id,
        cluster_assignment.assignment_status,
        cluster_assignment.similarity,
        reid_control.mode,
        reid_v2_assignment.id,
        reid_v2_assignment.profile_id,
        reid_v2_assignment.canonical_profile_id,
        reid_v2_assignment.assignment_basis,
        reid_v2_search.derivative_id
      ${orderByClause}
    `;
