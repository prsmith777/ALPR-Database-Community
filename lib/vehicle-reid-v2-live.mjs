...
export class VehicleReidV2LiveRepository {
  ...
  async discover({ limit = 25 } = {}) {
    ...
    // Keep standby genuinely inert. A control CTE inside the candidate query is
    // a correctness guard, but PostgreSQL may still plan and evaluate its
    // expensive exact-current branches before applying the mode predicate.
