...
export const CURRENT_RELEASE_NOTES = Object.freeze({
  title: "Reliable updater restart recovery",
  publishedAt: "2026-09-25",
  items: Object.freeze([
    "The Software Updates page now checks recovery through a stable authenticated endpoint instead of a build-specific Server Action.",
    "An open update tab detects when the server restarts onto a different release and performs a cache-busted full navigation.",
    "Update status responses remain permission-guarded, private, and explicitly excluded from browser and intermediary caches.",
  ]),
});
