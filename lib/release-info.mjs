...
export const CURRENT_RELEASE_NOTES = Object.freeze({
  title: "Full-page usability and settings correctness",
  publishedAt: "2026-09-25",
  items: Object.freeze([
    "The mobile More menu is restored, and Help is available from both desktop and mobile navigation.",
    "Software Updates now distinguishes a successful current-release check from a check that has not run and shows when the check completed.",
    "Database and Blue Iris settings owned by Docker environment variables are visibly read-only and protected against ignored browser submissions.",
    "Active Community Vehicle Intelligence navigation uses clear task names while retaining explicit ReID v1 context in the pages and manual.",
  ]),
});
