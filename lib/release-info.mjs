...
export const CURRENT_RELEASE_NOTES = Object.freeze({
  title: "Published installation guidance",
  publishedAt: "2026-09-24",
  items: Object.freeze([
    "New installations use the current exact release tag and the guided ./alpr-community install workflow.",
    "The historical v0.1.23 tag remains only the updater baseline for systems already running that exact release.",
    "The public README, update guide, roadmap, and embedded manual now describe the published Community release consistently.",
    "Transactional partition-safe rollback, explicit canonical-main release discovery, and commit-pinned image validation remain unchanged.",
  ]),
});
