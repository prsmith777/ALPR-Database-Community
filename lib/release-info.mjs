...
export const CURRENT_RELEASE_NOTES = Object.freeze({
  title: "July 30, 2026 release line",
  publishedAt: "2026-07-30",
  items: Object.freeze([
    "Fail-closed, no-input manual database-backup control plane, gated on the separately reviewed database-backup-create-v1 worker capability.",
