...
export const CURRENT_RELEASE_NOTES = Object.freeze({
  title: "Automated Community migration wizard",
  publishedAt: "2026-09-25",
  items: Object.freeze([
    "A resumable wizard creates a separate PostgreSQL 17 target and runs the guarded dump, restore, current migrations, reconciliation, and row-count validation.",
    "Local or SSH image storage is copied with rsync and verified by checksum before the target application starts.",
    "The target remains outbound-isolated through automated health and restart checks plus explicit browser acceptance.",
    "Activation, host-specific traffic cutover, rollback retention, and source deletion remain explicit operator decisions.",
  ]),
});
