...
export const CURRENT_RELEASE_NOTES = Object.freeze({
  title: "August 7, 2026 Blue Iris zone-crossing direction candidate",
  publishedAt: "2026-08-07",
  items: Object.freeze([
    "Replaced the unsuccessful dense clip vehicle-direction experiment with camera-scoped Blue Iris ordered zone-crossing shadow evidence whose mapping revisions cannot invalidate ReID history.",
