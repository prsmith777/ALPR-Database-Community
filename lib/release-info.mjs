...
export const CURRENT_RELEASE_NOTES = Object.freeze({
  title: "August 12, 2026 Entry Overview workflows",
  publishedAt: "2026-08-12",
  items: Object.freeze([
    "Separated the two Entry Overview workflows in Vehicle Views: direct Entry LPR mappings now make the reviewed Entry Overview/Cam143 binding discoverable, while the rare Street-to-driveway route remains a distinct dual-Entry-LPR corroboration layer.",
    "Added an independently guarded Cam143 route payload. The two exact Entry LPR reads still establish identity and timing; Off/Shadow/Active payload mode permits only a ready daytime Entry Overview image owned by one corroborating read, with immutable provenance and no raw Entry plate-image copy.",
