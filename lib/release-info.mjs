...
export const CURRENT_RELEASE_NOTES = Object.freeze({
  title: "Fresh-install bootstrap recovery",
  publishedAt: "2026-09-25",
  items: Object.freeze([
    "Fresh bootstrap clones now materialize a clean working tree before release verification.",
    "Bootstrap v4 narrowly resumes the unmaterialized canonical checkout left by the v0.1.36 bootstrap defect without weakening dirty-checkout protection.",
    "Installation and bootstrap guidance documents the safe retry path for affected v0.1.36 users.",
  ]),
});
