...
export const CURRENT_RELEASE_NOTES = Object.freeze({
  title: "Guarded Community updates",
  publishedAt: "2026-09-24",
  items: Object.freeze([
    "Added a guided host-side updater for standard Linux Docker Compose installations and Linux virtual machines.",
    "Updates use exact stable Git tags, commit-qualified images, transactional migrations, and automated health and data checks.",
    "One private database and configuration rollback generation is retained without copying the image-storage library.",
    "The application remains unprivileged and never receives the Docker socket; update and rollback actions stay on the host.",
  ]),
});
