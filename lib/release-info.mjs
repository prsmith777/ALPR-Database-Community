...
export const CURRENT_RELEASE_NOTES = Object.freeze({
  title: "August 16, 2026 ReID v2 shadow profile suggestions",
  ...
  items: Object.freeze([
    ...
    "ReID v2 Shadow can now create an immutable evidence-backed profile candidate snapshot from the current canonical crop inventory. Only exact effective/corrected plate agreement and audited human Same-vehicle labels can connect crops; cosine similarity never adds a member.",
    "Human Different labels, incompatible effective plates, ambiguous multi-plate evidence, stale links, and a truncated bounded scan fail closed. Excluded conflicts remain visible, identical evidence reuses the prior fingerprinted snapshot, and every newly created snapshot is audited.",
