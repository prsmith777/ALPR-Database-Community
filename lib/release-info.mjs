...
export const CURRENT_RELEASE_NOTES = Object.freeze({
  title: "Storage and privacy onboarding",
  publishedAt: "2026-09-24",
  items: Object.freeze([
    "Simplified Storage & Privacy for first-time Community administrators and moved specialist controls under Advanced Maintenance.",
    "Hidden unavailable optional host metrics and replaced impractical long-range capacity dates with a stable status.",
    "Clarified that retention and record-limit settings are planning inputs and never delete plate reads or source images.",
    "Added Email and Webhook readiness guidance and corrected the privacy integration inventory.",
  ]),
});
