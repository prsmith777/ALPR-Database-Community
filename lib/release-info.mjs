...
export const CURRENT_RELEASE_NOTES = Object.freeze({
  title: "Faster event-driven Recognition Feed",
  publishedAt: "2026-09-25",
  items: Object.freeze([
    "The Live Feed no longer reloads every five seconds, and the Recognition Feed viewer no longer queries every three seconds.",
    "New and visually processed reads arrive through an authenticated event stream and a bounded changed-row query.",
    "Concurrent session and update checks are coalesced so image-heavy pages do not amplify database traffic.",
    "Private conditional image caching and Server-Timing measurements reduce repeated work and expose remaining latency.",
  ]),
});
