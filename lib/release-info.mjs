...
export const CURRENT_RELEASE_NOTES = Object.freeze({
  title: "August 7, 2026 resilient LPR motion-anchor candidate",
  publishedAt: "2026-08-07",
  items: Object.freeze([
    "Phase 2A.1 scales stored Street LPR plate coordinates into Blue Iris timeline frames and permits one unambiguous LPR sample within 750 milliseconds when the exact-time frame is unavailable. Ambiguous matches remain Unknown, Street Overview is never used as a plate anchor, monochrome night direction remains disabled, and the evidence remains shadow-only.",
