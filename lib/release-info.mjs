...
export const CURRENT_RELEASE_NOTES = Object.freeze({
  title: "August 8, 2026 daytime overview Vehicle View candidate",
  publishedAt: "2026-08-08",
  items: Object.freeze([
    "Added a daytime-only Street Overview Vehicle View pipeline with 100-millisecond sampling across a bounded six-second alert window, local non-vehicle screening, camera-pair timing and Blue Iris direction association, conservative ambiguity refusal, and Entry LPR driveway fallbacks without camera clones.",
    "Normal new reads no longer search the plate-camera clip for a Vehicle View. Recognition Feed now distinguishes Waiting for daytime overview, Unavailable nighttime, no-match, ambiguity, and legacy outcomes, and hides Retry when another attempt cannot help.",
