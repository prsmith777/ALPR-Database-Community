...
export const CURRENT_RELEASE_NOTES = Object.freeze({
  title: "Friendlier first-time setup",
  publishedAt: "2026-09-26",
  items: Object.freeze([
    "The verified quick-start command now proceeds directly to a new installation without opening a script viewer or requiring a menu choice.",
    "Bootstrap choices, confirmations, progress stages, and errors use clearer first-time-user language while preserving fail-closed safety checks.",
    "The installer retries invalid entries, uses a detected time-zone default, summarizes the plan, and prints detected browser addresses when finished.",
  ]),
});
