...
export const CURRENT_RELEASE_NOTES = Object.freeze({
  title: "August 16, 2026 ReID v2 controlled Stage 2 cutover candidate",
  ...
  items: Object.freeze([
    ...
    "This source candidate implements Stage 2 but does not itself merge, deploy to staging or production, accept a production preview, or perform a production cutover. ReID v1 retirement and deletion remain later separately approved work.",
