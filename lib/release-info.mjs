...
export const CURRENT_RELEASE_NOTES = Object.freeze({
  title: "August 15, 2026 canonical crop embeddings",
  ...
  items: Object.freeze([
    ...
    "The embedding worker is campaign-only in this slice. No automatic queue, ReID v2 consumer, search, cluster, profile, vehicle assignment, attribute, direction, shadow-event, notification, Plate Recognizer, or other external-provider behavior is enabled.",
