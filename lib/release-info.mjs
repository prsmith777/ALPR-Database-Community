...
export const CURRENT_RELEASE_NOTES = Object.freeze({
  title: "Clean Community baseline candidate",
  publishedAt: "2026-09-22",
  items: Object.freeze([
    "Started the Community edition from a reviewed source snapshot without inherited Git history.",
    "Removed audited media, runtime data, private deployment material, and installation-specific defaults.",
    "Removed private-only chat, TPMS, radar traffic, privileged host-maintenance, and advanced rollout interfaces.",
    "Added portable Docker persistence, UTC defaults, PostgreSQL 17 deployment guidance, and a repository sanitation gate.",
  ]),
});
