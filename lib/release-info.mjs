...
export const CURRENT_RELEASE_NOTES = Object.freeze({
  ...
  items: Object.freeze([
    "Replaced the unsuccessful dense clip vehicle-direction experiment with isolated Blue Iris ordered zone-crossing shadow evidence carried by the existing plate alert.",
