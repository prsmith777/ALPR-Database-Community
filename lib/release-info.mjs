...
export const CURRENT_RELEASE_NOTES = Object.freeze({
  title: "August 7, 2026 navigation and motion-shadow staging candidate",
  ...
  items: Object.freeze([
    ...
    "Phase 2A reuses bounded Blue Iris samples to record isolated plate-anchored daytime camera-plane motion direction. Monochrome night reads explicitly remain Unknown, and a read-only Processing summary exposes shadow outcomes without changing displayed ReID direction, notifications, vehicle views, or read-review navigation.",
