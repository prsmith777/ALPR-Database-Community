...
export const CURRENT_RELEASE_NOTES = Object.freeze({
  title: "Community UI reliability fixes",
  publishedAt: "2026-09-24",
  items: Object.freeze([
    "Removed radar-only speed columns, filters, details, and query paths from the Community recognition feed.",
    "Corrected confidence formatting, nested integration headings, and completed-migration redirects.",
    "Made date and time rendering hydration-safe and stabilized Live Viewer refresh requests.",
    "Added accessible labels to dashboard time-distribution links and expanded regression coverage.",
  ]),
});
