...
export const ENTRY_OVERVIEW_HISTORY_CAMERA_NAME = "Gate Overview";
export const ENTRY_OVERVIEW_HISTORY_CAMERA_SHORT_NAME = "Overview01";
...
export function entryOverviewHistoryLifecycle(repository, read) {
  ...
  if (!Number.isSafeInteger(jobId) || jobId <= 0 || !claimToken) {
    throw new Error("A claimed Gate Overview history job is required.");
  }
  return {
