...
async function heartbeat(pool,inventory,workerId,now,databaseBackupSupported=false){
  await pool.query(`INSERT INTO public.host_maintenance_worker_state
    ...
    VALUES($1,$2,$3,$4,$5::timestamptz,$6,$7,$8,CASE WHEN $8 IS NULL THEN NULL ELSE $5::timestamptz END,NULL,$5::timestamptz) ON CONFLICT(environment_id) DO UPDATE SET database_identity=EXCLUDED.database_identity,
