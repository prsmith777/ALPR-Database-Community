...
export async function sendWebhookNotification({ config = {}, payload = {}, fetchImpl = fetch } = {}) {
  ...
  const url = await validateWebhookDestination(payload.url, config);
...
export const webhookNotificationInternals = Object.freeze({ deliveryError, ipv4Parts });
