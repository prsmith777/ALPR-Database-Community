...
function publicRun(row) {
  ...
  return {
    ...
    acceptedPreviewFingerprint: row.accepted_preview_fingerprint || null,
    ...
    acceptedActor: row.accepted_actor_username ? {
      username: row.accepted_actor_username,
      displayName: row.accepted_actor_display_name || row.accepted_actor_username,
    } : null,
