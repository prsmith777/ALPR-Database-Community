...
export class BlueIrisVehicleFrameService {
  ...
  async processOverviewRead({
    ...
    const historyMode = String(profile.profile_kind || "").trim() === "entry_history";
    ...
    try {
      ...
      if (this.timelineExportService) {
        ...
        timelineExport = await this.timelineExportService.acquire({
          ...
          profileKind: historyMode ? "entry_history" : null,
          profileIdentity: historyMode
        ...
        try {
          ...
          const readyFrame = {
            ...
            selectionMetadata: {
              ...
              profileKind: historyMode ? "entry_history" : "direction_profile",
