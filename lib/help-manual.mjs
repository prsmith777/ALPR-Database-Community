      ...
      blocks: [
        {
          ...
          items: [
            ...
            "Review the combined score, structural bit distance, color agreement, camera, time, plate, and both images before drawing a conclusion. Older assets safely fall back to structure-only ranking if their color signal is unavailable.",
