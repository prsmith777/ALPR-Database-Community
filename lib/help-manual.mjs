      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            "The Git SHA is unavailable when a deployment supplies neither a commit-pinned application image nor ALPR_RELEASE_SHA. This does not trigger a network lookup or guess from mutable state.",
