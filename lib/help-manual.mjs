      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            "The Recognition Feed image popup shows a Vehicle number, assignment state, ReID score, per-read color estimate, and direction when available. Uncertain evidence remains unassigned or Unknown.",
          ],
        },
        {
          type: "note",
      ...
      blocks: [
        {
          ...
          items: [
            ...
            "Expanded camera-pair Vehicle ReID calibration and optional make, model, color, body type, year, and jurisdiction filters.",
