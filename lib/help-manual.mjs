      ...
      blocks: [
        {
          ...
          items: [
            ...
            "Open Notification Rules from the left sidebar. On the Rules tab, select Create rule and enter a name, optional description, cooldown in seconds, and the explicit rule time zone. Every new draft resolves the browser-local time zone when Create rule is selected; quiet hours and new Schedule conditions inherit that rule time zone.",
