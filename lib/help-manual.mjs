      ...
      blocks: [
        {
          ...
          items: [
            ...
            "Choose whether the root group requires All or Any conditions. Conditions can match any accepted read, an exact or explicitly fuzzy plate, a known plate, a tag, a Monitored Plate, one or more cameras, a confidence threshold, or a local weekday/time schedule.",
            "Use Root for normal conditions and Nested for one reusable All/Any subgroup. The summary above the editor explains how the two groups combine.",
            ...
            "Select Preview to evaluate the saved version against up to 25 recent real reads. Review matched and non-matched rows; the preview always reports zero delivery attempts.",
