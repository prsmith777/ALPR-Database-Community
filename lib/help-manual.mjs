    ...
    },
    {
      ...
      blocks: [{
        ...
        items: [
          ...
          "For an existing-system migration, use the bootstrap migration-preparation mode on a separate Ubuntu 24.04 target, then run ./alpr-community migrate start. The assistant resumes completed checkpoints, stores no passwords, and never switches traffic or deletes the retained source.",
