      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            "OpenVINO first detects and tightly crops the vehicle, then vehicle-reid-0001 stores a normalized 512-value descriptor. A SHA-256 source hash separately identifies byte-for-byte duplicate captures.",
