      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            "Save the camera setup. Recent indexed captures are reevaluated, and each future indexed capture is evaluated asynchronously after ingestion.",
          ],
        },
        {
          type: "note",
