...
export const HELP_MANUAL = Object.freeze({
  ...
  coverageBaseline: "Application 0.1.9, feature baseline f354702",
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          type: "note",
          tone: "warning",
          title: "Advanced notification rules are planned",
          text: "The current page provides exact per-plate Pushover alerts. The channel-neutral rule schema and evaluator are foundation work only; count-within-period, schedules, nested-condition editing, tags, rarity, watchlist conditions, fuzzy matching, cooldowns, and shared multi-channel delivery are not available in the user interface yet.",
        },
      ],
    },
    {
      ...
      blocks: [
        {
          ...
          items: [
            ...
            "Vehicle image similarity search using crops, exact/perceptual hashes, and later learned embeddings.",
