      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            "After adding or changing calibration examples, use Re-evaluate selected camera or Re-evaluate all cameras to preview the affected counts and queue completed machine-generated results for another pass. Human front/rear reviews are preserved.",
            "The historical process resumes from durable results after a restart, retries an individual failure up to three times, preserves human front/rear reviews, and never sends historical direction notifications.",
          ],
        },
        {
          type: "note",
