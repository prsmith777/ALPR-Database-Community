      ...
      blocks: [
        {
          ...
          items: [
            "Open a capture from Recognition Feed or Plate Database, then choose Find similar vehicle. You can also open Visual Search and choose a recent indexed capture.",
            "Optionally narrow results by one or more cameras and a date range, then apply the filters.",
            "Review the match label, percentage, perceptual bit distance, camera, time, plate, and both images before drawing a conclusion.",
        ...
        },
        {
          ...
          items: [
            ...
            "The index stores a separate derived vehicle-region crop, a SHA-256 source hash for exact duplicates, and a 64-bit perceptual hash for near-identical frames.",
            "Exact duplicate means the complete stored source bytes match. Other percentages describe crop similarity and are candidate-ranking aids, not identity proof.",
