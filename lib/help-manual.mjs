      ...
      blocks: [
        {
          ...
          items: [
            ...
            "After an exact ALPR read match is found, select Select best vehicle frame. ALPR samples eight JPEG frames from two seconds before through five seconds after the read, scores vehicle visibility locally, and retains only the best frame on that read.",
