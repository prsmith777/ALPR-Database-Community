...
export const HELP_MANUAL = Object.freeze({
  ...
  coverageBaseline: "July 26, 2026 release line: complete Notification Rule lifecycle with independent tag and Known Plate context, tabbed integrations, durable delivery, completed legacy notification retirement, faster read review, read-only Storage Health with scheduled retention previews and bounded filesystem reconciliation, read-only installed release information, Monitored Plates, Vehicle ReID, configurable single-frame vehicle direction calibration with paced and explicitly repeatable historical evaluation, per-read color observations, and reviewable shadow vehicle clusters",
  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: "steps",
          title: "Review shadow vehicle clusters",
          items: [
            "Open Visual Search > Vehicle Clusters. Shadow means the grouping is a candidate for review, not a vehicle ownership or plate-mismatch claim.",
            ...
            "Observed plate badges on a cluster are review context. They do not establish that a vehicle owns or normally uses a plate.",
          ],
        },
        {
          type: "note",
          ...
          text: "Shadow clusters do not send notifications and do not label a plate as switched or stolen. Plate/vehicle association and mismatch rules require a later calibrated review phase with explicit confidence and evidence safeguards.",
        },
        {
          type: "note",
          tone: "warning",
