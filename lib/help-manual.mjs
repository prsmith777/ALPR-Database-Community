    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            "Open Visual Search > Vehicle Profiles. The Needs review area separates vehicle matches, plate associations, and direction reviews so each type of outstanding decision can be completed independently.",
            ...
            "Each review queue has its own Previous and Next controls, so completing one queue does not move the others. Counts cover the full database rather than only the current page.",
