...
export const HELP_MANUAL = Object.freeze({
  ...
  coverageBaseline: "July 25, 2026 release line: complete Notification Rule lifecycle, tabbed integrations, durable delivery, completed legacy notification retirement, faster read review, read-only Storage Health with scheduled dry-run retention previews, Monitored Plates, and Vehicle ReID",
      ...
      blocks: [
        {
          ...
          items: [
            ...
            "Use Refresh to take a new measurement. Exact filesystem reconciliation, destructive pruning, vacuum, and backup jobs remain future work and require separate approval.",
          ],
        },
        {
          type: "bullets",
