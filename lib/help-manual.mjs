    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            "Open Visual Search > Vehicle Profiles. Shadow means the ReID grouping is a candidate for review, not a vehicle ownership or plate-mismatch claim.",
            ...
            "Open an individual vehicle profile to review its member captures. Effective plates from human-confirmed members appear as separate association suggestions; Confirm association creates the trusted baseline, while Reject association preserves the ReID profile and records the rejection.",
            "Use Review visible features on a capture to record clearly visible traits such as a roof rack, rear bike rack, stickers, toolbox, trailer, aftermarket wheels, or visible damage. Unchecked means not confirmed in that image, not that the vehicle never has the feature.",
            "The profile counts repeated feature observations and lets the profile list filter by those reviewed traits. Every manual feature change is audited, and provider/model provenance is retained for later automatic classifiers.",
        ...
        },
        {
          ...
          text: "Confirmed plate associations establish an auditable baseline, but profiles and distinguishing features do not yet send mismatch notifications or label a plate as switched or stolen. Automated mismatch rules remain a later calibrated phase with minimum evidence and confidence safeguards.",
        },
        {
          type: "note",
          tone: "warning",
