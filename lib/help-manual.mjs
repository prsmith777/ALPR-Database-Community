    ...
    },
    {
      ...
      blocks: [{
        ...
        items: [
          ...
          "If the v0.1.36 bootstrap stopped immediately after cloning with Existing Community checkout is not clean, download and verify the latest bootstrap and rerun it. Bootstrap v4 can resume only the canonical checkout containing no files outside .git, no .env, and no indexed paths; every ordinary dirty checkout still fails closed.",
