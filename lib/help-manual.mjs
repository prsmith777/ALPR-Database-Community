...
export const HELP_MANUAL = Object.freeze({
  ...
  coverageBaseline: "July 24, 2026 release line: focused Notification Rules plus tabbed MQTT, Pushover, SMTP email, and signed webhook integration pages; durable delivery; completed legacy notification retirement; faster read review; read-only Storage Health; Monitored Plates; and Vehicle ReID",
