...
export const HELP_MANUAL = Object.freeze({
  ...
  coverageBaseline: "July 27, 2026 release line: complete Notification Rule lifecycle with independent tag and Known Plate context, tabbed integrations, durable delivery, completed legacy notification retirement, faster read review, read-only Storage Health with scheduled retention previews and bounded filesystem reconciliation, read-only installed release information, Monitored Plates, Vehicle ReID, configurable single-frame vehicle direction calibration with paced and explicitly repeatable historical evaluation, per-read color and automatic coarse vehicle-type observations, independently paginated Vehicle Intelligence review queues, reviewable vehicle profiles, and explicit plate associations",
