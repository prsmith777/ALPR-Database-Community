...
export const HELP_MANUAL = Object.freeze({
  ...
  coverageBaseline: "Application 0.1.9, production behavior through 513cc5d",
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          text: "The current page provides exact per-plate Pushover alerts. Count-within-period, schedules, nested conditions, tags, rarity, watchlist conditions, fuzzy matching, cooldowns, and multi-channel delivery are roadmap work and are not available yet.",
        },
      ],
    },
    {
