...
export const HELP_MANUAL = Object.freeze({
  ...
  coverageBaseline: "Production 4166d78, guarded unified rules and Vehicle ReID",
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            "Watchlist is the user-facing name for the older flagged-plate state. Use it for plates that require focused review; do not use it as a substitute for notes explaining why.",
            "The Watchlist page shows known name, last seen, read count, tags, and direct exact-match read history. Administrators and Operators can add or remove entries.",
            "A unified rule with the Watchlist condition decides which cameras and delivery channels act on a watchlisted read.",
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          text: "Production includes migration preview, disabled copies, a restricted editor, a no-delivery simulator, shadow comparison, approval evidence, atomic per-rule cutover, and rollback. A copied rule cannot deliver until its own review and cutover are complete. General-purpose creation and editing for every advanced condition remains planned.",
        },
      ],
    },
    {
