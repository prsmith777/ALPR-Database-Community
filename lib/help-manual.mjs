...
export const HELP_MANUAL = Object.freeze({
  ...
  coverageBaseline: "July 24, 2026 release line: notification operations with camera inactivity checks, quiet hours, durable Pushover delivery, alert traces and quota visibility; faster read review; read-only Storage Health; Monitored Plates; and Vehicle ReID",
  ...
  sections: [
    ...
    },
    {
      ...
      title: "Notification rules and Pushover",
      summary: "Build, preview, and activate unified MQTT or Pushover rules without bypassing migration safeguards.",
      roles: ["administrator"],
      ...
      blocks: [
        {
          ...
          items: [
            ...
            "Add one or more actions. MQTT actions use an existing broker and a per-camera or fixed topic. Pushover actions use the protected credentials from Settings and can specify priority and an optional message.",
            ...
            "Review Notification operations for each recent decision, its event-time trace, suppression reason, channel delivery state, retry attempts, and dead-letter error. Pushover and MQTT delivery failures retry asynchronously without holding open plate ingestion.",
        ...
        },
        {
          ...
          text: "New builder rules use disabled drafts, no-delivery preview, separate audited activation, atomic deactivation, and protected credential references. Migrated copies still require their existing shadow approval and cutover workflow; the general builder cannot edit or activate them. Unified MQTT and Pushover actions use durable, deduplicated delivery ledgers with bounded retries and dead-letter state. Legacy Pushover rows remain best-effort until their individual unified-rule cutover is complete.",
        },
      ],
    },
    {
      ...
      blocks: [
        {
          ...
          items: [
            "Additional notification conditions such as rarity, site/direction, and vehicle attributes, plus new email or webhook actions.",
