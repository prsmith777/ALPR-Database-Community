...
export const HELP_MANUAL = Object.freeze({
  ...
  coverageBaseline: "July 24, 2026 release line: unified MQTT, Pushover, SMTP email, and signed webhook notifications with durable delivery; faster read review; read-only Storage Health; Monitored Plates; and Vehicle ReID",
      ...
      blocks: [
        {
          ...
          items: [
            ...
            "After cutover, confirm Delivery Activity identifies the unified rule and succeeds. Use the per-rule rollback control if delivery does not behave as approved.",
