...
export const HELP_MANUAL = Object.freeze({
  ...
  coverageBaseline: "July 24, 2026 release line: faster read review, exact Known Plate history links, slashed-zero plate text, read-only Storage Health, unified notification rules, Monitored Plates, and Vehicle ReID",
      ...
      blocks: [
        {
          ...
          items: [
            ...
            "Open Notifications. In Unified notification rules, enter a name, optional description, and cooldown in seconds.",
        ...
        },
        {
          ...
          text: "New builder rules use disabled drafts, no-delivery recent-read preview, separate audited activation, atomic deactivation, and protected credential references. Migrated copies still require their existing shadow approval and cutover workflow; the general builder cannot edit or activate them. MQTT uses the durable outbox. Pushover remains best-effort after the read transaction commits, matching the existing Pushover reliability boundary.",
        },
      ],
    },
    {
      ...
      blocks: [
        {
          ...
          items: [
            "General-purpose creation and editing of unified rules with count/time windows, schedules, arbitrary nested conditions, rarity, cooldowns, and new email or webhook actions.",
