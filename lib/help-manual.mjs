...
export const HELP_MANUAL = Object.freeze({
  ...
  coverageBaseline: "July 24, 2026 release line: Monitored Plates, guarded unified rules, and Vehicle ReID",
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          type: "note",
          tone: "warning",
          title: "Unified rules use guarded cutover",
          text: "The release includes migration preview, disabled copies, a restricted editor, a no-delivery simulator, shadow comparison, approval evidence, atomic per-rule cutover, rollback, and audited retirement of safely disabled orphaned copies. A copied rule cannot deliver until its own review and cutover are complete. General-purpose creation and editing for every advanced condition remains planned.",
        },
      ],
    },
    {
