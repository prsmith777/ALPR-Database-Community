...
export const HELP_MANUAL = Object.freeze({
  ...
  sections: [
    ...
    },
    {
      ...
      summary: "Monitor application storage and use preview-first cleanup.",
      roles: ["administrator"],
      ...
      blocks: [{
        ...
        items: [
          "Storage health reports application-managed categories and database observations.",
    ...
    },
    {
      ...
      summary: "Protect persistent data and validate PostgreSQL upgrades.",
      roles: ["administrator"],
      ...
      blocks: [{
        ...
        items: [
          ...
          "Use a logical dump and a fresh PostgreSQL 17 volume when upgrading from PostgreSQL 13.",
          "Validate health, sign-in, ingestion, search, and image persistence after every deployment or restore.",
        ],
      }],
    },
    {
      ...
      blocks: [{
        ...
        items: [
          "Privileged host maintenance and automated database backup execution are not included.",
