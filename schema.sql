...
CREATE TABLE IF NOT EXISTS public.radar_settings (
    ...
    legacy_correlation_enabled BOOLEAN NOT NULL DEFAULT FALSE,
    clock_sanity_seconds INTEGER NOT NULL DEFAULT 300 CHECK (clock_sanity_seconds BETWEEN 5 AND 86400),
