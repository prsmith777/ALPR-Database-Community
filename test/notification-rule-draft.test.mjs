...
function draftPool({ deliveryEnabled = false, includeKnownGuard = true, nested = true } = {}) {
  ...
  const conditionRows = [
    ...
    { id: 3, group_id: 61, condition_type: "camera", operator: "in", operand: { names: ["Gate LPR 1"] }, position: 2 },
  ];
  const client = {
