...
test("crop-owned attribute compatibility remains without private processing controls", async () => {
  ...
  assert.doesNotMatch(settings, /VehicleAssetAttributePanel/);
  assert.doesNotMatch(loader, /getVehicleAssetAttributeOverview/);
});
