...
function activityDraft(overrides = {}) {
  return {
    ...
    conditionTree: {
      ...
      combinator: "all",
      children: [
        { kind: "condition", conditionType: "camera", operator: "in", value: { names: ["Gate LPR"] } },
...
test("scheduled camera checks record a trace and queue a durable Pushover delivery", async () => {
  ...
  const mqttRepository = {
    ...
    async discoverCamera() { return { id: 2, cameraName: "Gate LPR", cameraKey: "entry-lpr", topicOverride: "" }; },
  };
