...
test("Quick Look prefers a ready Gate Overview image over other overview-family sources", () => {
...
test("Quick Look chooses Gate Overview over a newer plate-camera fallback", () => {
...
test("Quick Look uses a ready historical Gate Overview crop only in tile four", () => {
  const originals = plateImages();
