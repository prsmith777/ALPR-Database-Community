...
test("v2 pair reviews canonicalize crop pairs and summarize labels without recommending a threshold", () => {
  ...
  const summary = summarizeVehicleReidV2Reviews([
    { label: "same_vehicle", similarity_score: 0.86, evidence_context_low: "entry", evidence_context_high: "entry", evidence_camera_low: "Gate LPR 1", evidence_camera_high: "Gate LPR 2" },
    ...
    { label: "different_vehicle", similarity_score: 0.92, evidence_context_low: "entry", evidence_context_high: "entry", evidence_camera_low: "Gate LPR 1", evidence_camera_high: "Gate LPR 1" },
    { label: "unsure", similarity_score: 0.91, evidence_context_low: "entry", evidence_context_high: "street", evidence_camera_low: "Gate LPR 1", evidence_camera_high: "Street LPR 1" },
  ]);
...
test("shadow overview bounds browsing, searches current evidence, and skips invalid candidates", async () => {
  const rows = [
    ...
    row({ derivative_id: 2, camera_names: ["Gate LPR 2"], embedding: Buffer.alloc(12), total_sources: "12" }),
